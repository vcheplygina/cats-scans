...
def main():
    ...
    # === Plot comparison between taxonomical distance and task2vec_fullcode distance ===
    ...
    ax = fig.gca()
    # Plot how the average task2vec_fullcode and taxonomical distance change as the neighborhood changes
