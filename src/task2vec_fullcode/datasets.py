...
def cub_inat2018(root, config):
    ...
    if 0 <= config.task_id < NUM_CUB:
        # CUB
        # from src.task2vec_fullcode.dataset.cub import CUBTasks, CUBDataset
...
def imat2018fashion(root, config):
    ...
    # from src.task2vec_fullcode.dataset.imat import iMat2018FashionDataset, iMat2018FashionTasks
...
def split_mnist(root, config):
    ...
    # from src.task2vec_fullcode.dataset.mnist import MNISTDataset, SplitMNISTTask
...
def split_cifar(root, config):
    ...
    # from src.task2vec_fullcode.dataset.cifar import CIFAR10Dataset, CIFAR100Dataset, SplitCIFARTask
...
def cifar10_mnist(root, config):
    # from src.task2vec_fullcode.dataset.cifar import CIFAR10Dataset
    # from src.task2vec_fullcode.dataset.mnist import MNISTDataset
    # from src.task2vec_fullcode.dataset.expansion import UnionClassificationTaskExpander
