...
import logging
# import src.task2vec_fullcode.variational as variational
import src.task2vec_fullcode.variational as variational

from torch.utils.data import DataLoader, Dataset
from torch.optim.optimizer import Optimizer
# from src.task2vec_fullcode.utils import AverageMeter, get_error, get_device
...
class Task2Vec:
    ...
    def _fit_classifier(self, optimizer='adam', learning_rate=0.0004, weight_decay=0.0001,
        ...
        targets = self.model.classifier.targets.cuda()
        features = self.model.classifier.input_features.cuda()
